...
<html>
    ...
    <body>
        ...
        <div class="header_logo">
            <h1>
                <a href="index.html" alt="亿点商城">亿点商城</a>
            </h1>
        </div>
...
<!--            扫码登陆-->
            <div class="login_scan" style="display: block">
                ...
                <p class="free"><a href="../html/register.html">免费注册 有惊喜 ></a></p>
            </div>
<!--账户登录-->
                ...
                <div class="login_username" style="display: block;">
                    ...
                    <div class="username_box">
                        <div class="input_box" id="showErrorUsernameDiv">
                            <input id="user_phone" value="" placeholder="用户名/手机/邮箱/门店会员卡号" tabindex="1" type="text">
                    ...
                    <div class="password_box">
                        <div class="input_box" id="showErrorPwdDiv">
                            <input id="password" placeholder="密码" tabindex="2" type="password">
                    ...
                    <a id="submit1" href="javascript:void(0)" name="Logon_index_denglu002" class="login_submit">登 录</a>
                </div>
...
<!--                            <label>手机验证码</label>-->
                    ...
                    <a id="submit2" href="javascript:void(0)" name="Logon_index_denglu002" class="login_submit">登 录</a>
                </div>
    ...
    <script>
        ...
        var el = content.querySelector('.copyright');
