...
public class Specification_optionsAction extends ActionSupport implements ModelDriven<Specification_options> {
	...
	public String delete() {
		b=this.specification_optionsService.delete(specification_options.getSpecification_option_id());
		jsonObject.clear();
		if(b) {
	...
	public String findById() {
		Specification_options specification_options1=this.specification_optionsService.findById(specification_options.getSpecification_option_id());
